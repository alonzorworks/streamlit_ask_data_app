...
if input_file is not None:
    ...
    # CSV Will Not work but we will keep the code anyway 
    #Must use bytes to get the file info 
    ...
    # No need to mess with the above the df code that already works 
    # Will try to export the df into another file 
    
    df_export = input_file
